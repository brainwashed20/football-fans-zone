        ...
        e.prototype = {
                ...
                if (this.options.src && 0 < this.options.src.length) {
                    ...
                    d.author = this.options.youtubechannel.author : this.options.youtubechannel.q && (d.q = this.options.youtubechannel.q), d = "https://gdata.youtube.com/feeds/api/videos?" + c.param(d), b = this, c.getJSON(d, function (c) {
                        if (c && c.feed && c.feed.entry)
                            for (var d = 0; d < c.feed.entry.length; d++) b.elemArray.push([d, "http://img.youtube.com/vi/" + c.feed.entry[d].media$group.yt$videoid.$t + "/0.jpg", c.feed.entry[d].media$group.media$player.url, null, null, null, null, c.feed.entry[d].media$group.media$title.$t, c.feed.entry[d].media$group.media$description.$t,
                                9, 640, 480, "http://img.youtube.com/vi/" + c.feed.entry[d].media$group.yt$videoid.$t + "/0.jpg", null, null, null
                            ]);
                        b.readTags();
                        a(b)
            ...
            readTags: function () {
                ...
                c("img", this.container).each(function () {
                    ...
                    var k = c(this).parent().data("mediatype") ? c(this).parent().data("mediatype") :
                        a.checkType(d);
            ...
            createMarkup: function () {
                this.$gallery = jQuery("<div class='html5gallery-container-" + this.id + "'><div class='html5gallery-box-" + this.id + "'><div class='html5gallery-elem-" + this.id + "'></div><div class='html5gallery-title-" + this.id + "'></div><div class='html5gallery-timer-" + this.id + "'></div><div class='html5gallery-viral-" + this.id + "'></div><div class='html5gallery-toolbox-" + this.id + "'><div class='html5gallery-toolbox-bg-" +
                    ...
                    this.id + "'></div></div><div class='html5gallery-car-slider-bar-" + this.id + "'><div class='html5gallery-car-slider-bar-top-" + this.id + "'></div><div class='html5gallery-car-slider-bar-middle-" + this.id + "'></div><div class='html5gallery-car-slider-bar-bottom-" + this.id + "'></div></div><div class='html5gallery-car-left-" + this.id + "'></div><div class='html5gallery-car-right-" + this.id + "'></div><div class='html5gallery-car-slider-" + this.id + "'></div></div></div></div>");
            ...
            showYoutube: function (a) {
                ...
                } else g = this.prepareYoutubeHref(g), a && (g = 0 > g.indexOf("?") ? g + "?autoplay=1" : g + "&autoplay=1"), g = 0 > g.indexOf("?") ? g + "?wmode=transparent&rel=0" : g + "&wmode=transparent&rel=0", c("#html5gallery-elem-video-" +
                    this.id, d).html("<iframe width='" + b + "' height='" + e + "' src='" + g + "' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>");
                this.options.googleanalyticsaccount && window._gaq.push(["_trackEvent", "Video", "Play", this.elemArray[this.curElem][7]])
            },
            showVimeo: function (a) {
                ...
                c(".html5gallery-elem-" + this.id, d).html("<div class='html5gallery-loading-center-" + this.id + "'></div><div class='html5gallery-elem-video-" + this.id + "' style='display:block;position:absolute;overflow:hidden;top:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;left:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;width:" +
                    b + "px;height:" + e + "px;'></div>" + this.options.watermarkcode);
            ...
            checkType: function (a) {
                return !a ? -1 : a.match(/\.(jpg|gif|png|bmp|jpeg)(.*)?$/i) ? 1 : a.match(/[^\.]\.(swf)\s*$/i) ? 2 : a.match(/[^\.]\.(mp3)\s*$/i) ? 3 : a.match(/[^\.]\.(pdf)\s*$/i) ?
                    4 : a.match(/\.(flv)(.*)?$/i) ? 5 : a.match(/\.(mp4|m4v)(.*)?$/i) ? 6 : a.match(/\.(ogv|ogg)(.*)?$/i) ? 7 : a.match(/\.(webm)(.*)?$/i) ? 8 : a.match(/\:\/\/.*(youtube\.com)/i) || a.match(/\:\/\/.*(youtu\.be)/i) ? 9 : a.match(/\:\/\/.*(vimeo\.com)/i) ? 10 : 0
            },
            onChange: function () {
            ...
            onSlideshowOver: function () {
                if (this.options.onslideshowover && window[this.options.onslideshowover] &&
                    "function" == typeof window[this.options.onslideshowover]) window[this.options.onslideshowover](this.elemArray[this.curElem])
            },
            ...
            embedHTML5Video: function (a, d, b, e, g, h, f, j) {
                ...
                this.options.nativehtml5controls || (c("video", a).data("src", e), c("video", a).data("hd", g), c("video", a).data("ishd", this.isHd), c("video", a).addHTML5VideoControls(this.options.skinfolder,
                    this));
